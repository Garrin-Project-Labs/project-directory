...
Project workspace for the Discord-bound OpenClaw agent `directory`.

- Discord guild ID: `1515020347425030245`
- Discord channel ID: `1519415648382353569`
- Agent ID: `directory`
- Default model: `gpt-5.5`
- Workspace: `/home/garrin/.openclaw/workspace-directory`
- Visibility: `public`
- GitHub Pages: `enabled`
- GitHub Pages URL: `https://garrin-project-labs.github.io/project-directory/`
- GitHub repo: `Garrin-Project-Labs/project-directory` (public)
...
- Contributor: `directory-contributor`
- Maintainer: `directory-maintainer`
